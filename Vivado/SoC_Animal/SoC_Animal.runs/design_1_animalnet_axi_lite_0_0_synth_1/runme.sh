...
HD_PWD='C:/Users/NguyenHuy/Downloads/SoC_Animal/SoC_Animal.runs/design_1_animalnet_axi_lite_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_animalnet_axi_lite_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_animalnet_axi_lite_0_0.tcl
